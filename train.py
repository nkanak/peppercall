...
parser.add_argument('--train-percentage', dest='TRAIN_PERCENTAGE', type=float, default=0.7)
parser.add_argument('--validation-percentage', dest='VALIDATION_PERCENTAGE', type=float, default=0.2)
...
with mlflow.start_run():
    ...
    forecaster = forecasting.SingleShotForecaster(study.best_params['lstm_units'], OUT_STEPS)
